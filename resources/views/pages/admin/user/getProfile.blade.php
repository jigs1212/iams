                            ...
                            {!! Form::open(array('url'=>'admin/user/' . $profile->id,'class'=>'form-horizontal','method' => 'PUT','id'=>'edit_user')) !!}
                                <div class="row clearfix">
                                    ...
                                    <div class="col-md-4 col-xs-10">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input type="date" id="birthday" name="bday" class="form-control" value="{{ $profile->bday }}">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-2 col-xs-2 form-control-label">
                                    ...
                                    <div class="col-sm-3 col-xs-10">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input type="number" name="ph_office" id="phone" max="9999999999" min="1000000000" maxlength="10" size="10" class="form-control" value="{{ $profile->ph_office }}">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-1 col-xs-2 form-control-label">
