                            ...
                            <div class="row clearfix">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-9 col-sm-7 col-xs-6">
                                        <div class="form-group">
                                            <div class="form-line">
                                                {!! Form::number('warranty_period','',array('class' => 'form-control','placeholder'=>'[Warranty Period in months]','id'=>'warranty_period'))!!}
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-2 col-sm-7 col-xs-6">
                                        <div class="form-group">
                                            <div class="form-line">
                                                {!! Form::date('date_of_end_of_warranty','',array('class' => 'form-control date padding-0','placeholder'=>'Ex: 2016/30/07','id'=>'date_of_end_of_warranty'))!!}
